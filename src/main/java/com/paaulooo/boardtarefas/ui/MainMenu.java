...
import com.paaulooo.boardtarefas.service.BoardService;
...
import static com.paaulooo.boardtarefas.persistence.entity.ColumnEnum.FINAL;
import static com.paaulooo.boardtarefas.persistence.entity.ColumnEnum.INITIAL;
import static com.paaulooo.boardtarefas.persistence.entity.ColumnEnum.PENDING;
...
public class MainMenu {
    ...
    private ColumnEntity createColumn(final String name, final ColumnEnum kind, final int order){
        var boardColumn = new ColumnEntity();
